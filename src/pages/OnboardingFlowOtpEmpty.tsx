...
import VerificationCodeInputField from "../components/VerificationCodeInputField";
import ActionsContainer from "../components/ActionsContainer";
import OnboardingHeader from "../components/OnboardingHeader";
import styles from "./OnboardingFlowOtpEmpty.module.css";

const OnboardingFlowOtpEmpty: FunctionComponent = () => {
  return (
    <div className={styles.onboardingFlowOtpEmpty}>
      <div className={styles.onboardingMainContainer}>
        ...
        <div className={styles.questionMainContainer}>
          <div className={styles.questionContainer}>
            <div className={styles.question}>Confirm your phone number</div>
          ...
          <div className={styles.optionsContainer}>
            <div className={styles.otpContainer}>
              <div className={styles.supportingText}>
                Enter the code sent to +1 (123) 456-7890
              </div>
              ...
              <div className={styles.buttonsbutton}>
                ...
                />
                <div className={styles.text}>Resend code</div>
                <img
                  className={styles.placeholderIcon}
                  alt=""
                  src="/placeholder3.svg"
...
export default OnboardingFlowOtpEmpty;
